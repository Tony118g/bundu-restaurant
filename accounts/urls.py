...
urlpatterns = [
    ...
    path('accounts/delete_account/<str:pk>/', views.delete_account, name='delete_account'),
    path('accounts/password/change/', auth_views.PasswordChangeView.as_view(success_url=reverse_lazy('profile_page'))),
